...
#eval gris model in coraa dataset 
...
#eval distil model in nurcsp dataset
Xpython ../../test.py --output_csv d:/results/output_distil_nurcsp.csv --config_path ./configs/config_eval_nurcsp.json --checkpoint_path_or_name d:/models/distil-large-nurc-sp --no_kenlm
...
#eval gris model in commonvoice dataset 
